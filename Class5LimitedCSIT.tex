...
\begin{columns}
 \begin{column}{6cm}    
    ...
    \draw [draw,->,align=center] (rxant1) -- (sumacc);
    \node [block, right of=sumacc, node distance=1.75cm, name=wf] {$\Gb_{\h}^H\Delb_{(1,-1^*)}$};  
...
%             \draw [draw,loosely dotted,-,align=center] (txant\a)  -- node {$h_\a^*$} (rxant1);
            ...
            \node [block, right of=sumz\a, node distance=2.5cm, name=wf\a] {$\Gb_{\h}^H\Delb_{(1,-1^*)}$}; 
...
\end{figure}
\begin{itemize}
 \item Alamoutti decoding $\rr_{STC-j}=\Gb_{\h}^H\Delb_{(1,-1^*)}\y_i=(|h_{j,1}|^2+|h_{j,2}|^2)\I\x =\|\h_j\|^2 \x$
